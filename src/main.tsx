...
Content:
{
  ...
  "id": "eu.kiefte.issue-tracker"
        ...
        <p style={{ marginTop: 6, color: '#777' }}>
          <strong>Element Web:</strong> do <em>not</em> use the "Custom" widget panel — it bypasses the Widget API.
          Use Room Settings → Developer Tools → Send custom state event, or use the{' '}
